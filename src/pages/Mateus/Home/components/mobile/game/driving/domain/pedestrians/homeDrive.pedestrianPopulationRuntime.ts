...
const DEFAULT_RESIDENT_POOL_LOCK_AFTER_BOOT = true;
const DEFAULT_RESIDENT_POOL_ALLOW_RUNTIME_EXPANSION = false;
...
function resolveResidentPoolConfig(
  ...
  return {
    ...
    lockAfterBoot:
      options.pedestrianResidentPoolLockAfterBoot ??
      DEFAULT_RESIDENT_POOL_LOCK_AFTER_BOOT,
    allowRuntimeExpansion:
      options.pedestrianResidentPoolAllowRuntimeExpansion ??
      DEFAULT_RESIDENT_POOL_ALLOW_RUNTIME_EXPANSION,
...
export function createInitialHomeDrivePedestrianPopulationRuntime(
  ...
  return {
    ...
    bootPreloadDiagnostics: undefined,
