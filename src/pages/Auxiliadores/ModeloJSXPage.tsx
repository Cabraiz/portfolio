  ...
  return (
    <Stack w="inherit">
      <InputGroup
        ...
        startElement={EsquerdoJSX}
        endElement={DireitoJSX}
      >
        <Input
          value={params.value}
      ...
      {params.error && (
        <Text className="form-helper-font" color="red.500" fontSize="sm" mt="1">
          {params.helperText}
        </Text>
      )}
    </Stack>
    ...
    >
      ...
      >
        ...
        <Box marginTop="6">
          ...
          <Text color="gray.600" marginTop="4">
            Isso pode demorar um pouco, dependendo da quantidade de dados que
